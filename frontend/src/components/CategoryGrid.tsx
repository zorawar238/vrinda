...
export function CategoryGrid() {
  return (
    <section className="bg-[#f0f0f0] relative overflow-hidden font-sans selection:bg-blue-500 selection:text-white">

      {/* ============================================= */}
      {/* MOBILE LAYOUT (< 768px)                       */}
      {/* Clean vertical flow, no absolute positioning   */}
      {/* ============================================= */}
      <div className="md:hidden flex flex-col items-center relative px-4 pt-8 pb-16">
        ...
        {/* Main Image */}
        <div className="relative z-10 w-[92%] max-w-[400px] mt-20 sm:mt-24">
          <img
            src="/featured/image1.png"
            alt="Main Feature"
            className="w-full h-auto object-cover drop-shadow-[0_20px_20px_rgba(0,0,0,0.25)] filter contrast-110 saturate-125"
          />
        </div>

        {/* Thumbnail Gallery Row */}
        <div className="relative z-10 flex gap-3 mt-6 w-[92%] max-w-[400px] justify-center">
          <div className="border-[1.5px] border-secondary p-0.5 bg-white shadow-lg flex-1 max-w-[30%]">
            <img src="/featured/image2.png" alt="Detail Front" className="w-full h-20 sm:h-24 object-cover object-top" />
          </div>
          <div className="border-[1.5px] border-secondary p-0.5 bg-white shadow-lg flex-1 max-w-[30%]">
            <img src="/featured/image3.png" alt="Detail Back" className="w-full h-20 sm:h-24 object-cover object-center" />
          </div>
          <div className="border-[1.5px] border-secondary p-0.5 bg-white shadow-lg flex-1 max-w-[30%]">
            <img src="/featured/image1.png" alt="Detail Extra" className="w-full h-20 sm:h-24 object-cover" />
          </div>
        </div>

        {/* MacOS Alert Box */}
        <div className="relative z-10 mt-6 w-[92%] max-w-[400px]">
          <div className="bg-[#fcfcfc]/90 backdrop-blur-md rounded-md shadow-lg overflow-hidden border border-gray-300">
        ...
        {/* Info Card */}
        <div className="relative z-10 mt-6 w-[92%] max-w-[400px]">
          <div className="bg-[#fcfcfc] p-6 rounded-3xl shadow-2xl relative overflow-hidden border border-gray-100">
            <h2 className="text-secondary font-serif text-[2rem] sm:text-[2.25rem] leading-none mb-1">
            ...
            <div className="mb-3 mt-2">
              <h4 className="text-secondary font-serif text-base leading-tight">Deadline of Orders</h4>
              <p className="font-serif italic text-secondary text-sm">/January 31, 2026/</p>
            </div>
            ...
            <ul className="list-disc list-inside text-[11px] text-gray-900 font-bold mb-3 ml-1">
              <li>Medium</li>
              <li>Large</li>
              <li>X-Large</li>
              <li>XX-Large</li>
            ...
            <div className="flex items-baseline gap-1 mt-2">
              <span className="text-[2.75rem] font-serif text-gray-900 tracking-tighter leading-none">799</span>
      ...
      {/* Original editorial scrapbook with absolutes    */}
      {/* ============================================= */}
      <div className="hidden md:block min-h-[788px] relative">
        <div className="absolute inset-0 w-full h-full flex items-center justify-center scale-[0.875] origin-center">
          <div className="w-full h-[900px] relative flex items-center justify-center px-6 py-12">
            ...
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-[120%] flex justify-center pointer-events-none select-none z-0">
              <h1
                className="mt-12 mb-8 text-[22rem] text-[#3d3d3d]/90 leading-none whitespace-nowrap drop-shadow-sm pr-12"
                style={{ fontFamily: "'Badaboom BB', cursive" }}
              >
                Order Now
              </h1>
            ...
            <div className="max-w-[1200px] w-full h-[800px] relative z-10 mx-auto">
              ...
              <div className="absolute top-10 right-20 z-20">
                <div className="relative border-[1.5px] border-secondary p-0.5 bg-white shadow-xl w-56">
              ...
              <div className="absolute top-[40%] left-24 z-30">
              ...
              <div className="absolute bottom-12 right-[15%] z-30">
