    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12 animate-fade-in">
      <div className="w-full max-w-md border border-foreground/10 bg-background/50 p-10 md:p-14">
        <div className="text-center mb-10">
          ...
          <p className="font-sans text-xs tracking-widest uppercase text-foreground/50">Join the Vrinda collective</p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-8">
          <div>
            <label className="block font-sans text-xs tracking-widest uppercase text-foreground/50 mb-3">Full Name</label>
            <input 
              type="text" 
        ...
        <div className="mt-12 text-center border-t border-foreground/10 pt-8">
          <p className="font-sans text-xs tracking-wide text-foreground/50 mb-4">Already have an account?</p>
          <Link to="/login" className="font-sans text-xs tracking-widest uppercase text-foreground hover:text-primary transition-colors underline underline-offset-4">
            Sign In Here
          </Link>
        </div>
      </div>
